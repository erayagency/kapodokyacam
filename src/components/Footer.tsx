...
export default function Footer() {
  ...
  return (
    <>
      <footer className="pt-[70px] pb-[70px] bg-gold">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-center items-center text-white">
            ...
            <div className="hidden md:flex md:w-1/6 justify-center mt-3">
              <ul>
                {footerLinks.map((link) => (
                  <li key={link.href}>
                    <Link href={link.href} className="text-white hover:opacity-70">
                      {link.label}
                    </Link>
                  </li>
                ))}
            ...
            <div className="md:w-1/3 text-center md:text-left">
              <p>
                <a href={`tel:${siteConfig.phone1Raw}`} className="text-white hover:opacity-70 block md:inline">
                  <i className="fa-solid fa-phone mr-2"></i>
                  {siteConfig.phone1}
                </a>
              </p>
              <p>
                <a href={`tel:${siteConfig.phone2Raw}`} className="text-white hover:opacity-70 block md:inline">
                  <i className="fa-solid fa-phone mr-2"></i>
                  {siteConfig.phone2}
                </a>
              </p>
              <p>
                <a href={`mailto:${siteConfig.email1}`} className="text-white hover:opacity-70">
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full bg-gold z-[99] text-center">
        <a
          href={`tel:${siteConfig.phone1Raw}`}
          className="flex items-center justify-center text-white font-bold text-[22px] py-[15px]"
        >
          <i className="fa fa-phone-square text-3xl mr-2"></i>
          <span>HEMEN ARA</span>
        </a>
      </div>
    </>
